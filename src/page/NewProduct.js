...
const NewProduct = () => {
  ...
  return (
    ...
    <form className='m-auto w-full max-w-md  shadow flex flex-col p-3 bg-white' onSubmit={handleSubmit}>
     ...
     <button className="w-full m-auto  bg-slate-500 hover:bg-slate-950 cursor-pointer  text-white text-l font-medium text-center py-1 rounded-full mt-4">Save</button>
     {/* <button className='bg-slate-500 hover:bg-slate-950  text-white text-lg font-medium my-2 drop-shadow rounded-full'>Save</button> */}
    </form>
    </div>
  )
}
